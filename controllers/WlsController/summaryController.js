...
exports.Get_person_by_id = (req, res) => {
  ...
  exports.get_summary = (req, res) => {
    ...
    sql_get_summary += "GROUP BY wls_summary.person_id\n";
...
exports.get_summary_detail_by_summary_id = (req, res) => {
  ...
  sql_get_summary_detail_by_summary_id +=
    ...
    sql_get_summary_detail_by_summary_id += "LEFT JOIN wls_summary ON wls_summary_detail.summary_id = wls_summary.summary_id \n";
    sql_get_summary_detail_by_summary_id += "WHERE wls_summary_detail.summary_id = ?\n";
    sql_get_summary_detail_by_summary_id += "ORDER BY wls_summary_detail.summary_detail_date";
  //   SELECT *
  ...
  try {
    dbConnect.query(sql_get_summary_detail_by_summary_id, [req.body.summary_id], (err, results) => {
      if (err) {
        res.json({
          status: false,
...
exports.get_summary_by_person_id =(req,res) => {
  ...
  // GROUP BY person_id
  try {
    dbConnect.query(sql_get_summary_by_person_id,[req.body.person_id],(err, results) => {
      if (err) {
        res.json({
          status: false,
